...
def _load_credit2(mydb):
    ...
    logging.info(f"Credits loading finish...total time : {end - start} ms")


def _load_movie2(mydb):
    logging.info("Start loading movie metadata...")
    col = mydb['movies_metadata']
    ...
    logging.info(f"Movie metadata loading finish...{end-start}ms")


def _load_keyword2(mydb):
    logging.info("Start loading keywords...")
    col = mydb['keywords']
    ...
    logging.info(f"keywords loading finish...total time: {end-start} ms")


def _load_link2(mydb):
    logging.info("Start loading links...")
    col = mydb['links']
    ...
    logging.info(f"Links loading finish...total time: {end-start} ms")

def _load_rating2(mydb):
    logging.info("Start loading ratings...")
    col = mydb['ratings']
    ...
    logging.info(f"ratings loading finish...total time: {end-start} ms")
...
if __name__ == '__main__':
    ...
    # _load_credit2(mydb=mydb)
    # _load_movie2(mydb=mydb)
    # _load_keyword2(mydb=mydb)
    # _load_link2(mydb=mydb)
    _load_rating2(mydb=mydb)
