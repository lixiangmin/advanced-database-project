...
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/movies_metadata.csv'
into table movies_metadata
fields terminated by ',' optionally enclosed by '"'
lines terminated by '\n'
IGNORE 1 LINES;
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/movies_metadatabelongs_to_collection.csv'
into table movies_metadatabelongs_to_collection
fields terminated by ',' optionally enclosed by '"'
lines terminated by '\n'
IGNORE 1 LINES;
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/movies_metadatagenres.csv'
into table movies_metadatagenres
fields terminated by ',' optionally enclosed by '"'
lines terminated by '\n'
IGNORE 1 LINES;
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/movies_metadataproduction_companies.csv'
into table movies_metadataproduction_companies
fields terminated by ',' optionally enclosed by '"'
lines terminated by '\n'
IGNORE 1 LINES;
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/movies_metadataproduction_countries.csv'
into table movies_metadataproduction_countries
fields terminated by ',' optionally enclosed by '"'
lines terminated by '\n'
IGNORE 1 LINES;
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/movies_metadataspoken_languages.csv'
...
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/links.csv'
into table links
fields terminated by ',' optionally enclosed by '"'
lines terminated by '\n'
IGNORE 1 LINES;
...
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/ratings.csv'
into table ratings
fields terminated by ',' optionally enclosed by '"'
lines terminated by '\n'
IGNORE 1 LINES;
...
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/credits_new.csv'
into table credits_new
fields terminated by ',' optionally enclosed by '"'
lines terminated by '\n'
IGNORE 1 LINES;
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/credits_newcast.csv'
into table credits_newcast
fields terminated by ',' optionally enclosed by '"'
lines terminated by '\n'
IGNORE 1 LINES;
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/credits_newcrew.csv'
...
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/keywords.csv'
into table keywords
fields terminated by ',' optionally enclosed by '"'
lines terminated by '\n'
IGNORE 1 LINES;
load data infile '/home/lc/Task/Course/DBcourse/src/processedData/keywordskeywords.csv'
